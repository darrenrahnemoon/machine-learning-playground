...
namespace ML {
	...
	template<typename LabelType, typename FeatureType>
	std::vector<std::shared_ptr<DataPoint<LabelType, FeatureType>>> KNN<LabelType, FeatureType>::getNearestNeighbors(std::shared_ptr<DataPoint<LabelType, FeatureType>> point) {
